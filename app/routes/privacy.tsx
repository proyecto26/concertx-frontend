  ...
  return (
    <Layout title="ConcertX - Privacy Policy">
      <section className="mt-10 container mx-auto px-6 py-12">
        ...
        <p className="text-base lg:text-lg mb-6">We may collect the following types of information about you:</p>
        <ul className="list-disc pl-6">
          <li className="text-base lg:text-lg mb-4">Personal information, such as your name, email address, and phone number, that you provide to us when you create an account or when you communicate with us.</li>
          <li className="text-base lg:text-lg mb-4">Information about your interactions with the Services, such as your IP address, the pages you visit, and the actions you take.</li>
          <li className="text-base lg:text-lg mb-4">Information about your device, such as your device type, operating system, and browser type.</li>
        </ul>
        <h2 className="text-2xl font-medium mb-4">How We Use Your Information</h2>
        <p className="text-base lg:text-lg mb-6">We use the information we collect about you for the following purposes:</p>
        <ul className="list-disc pl-6">
          <li className="text-base lg:text-lg mb-4">To provide the Services to you and to personalize your experience.</li>
          <li className="text-base lg:text-lg mb-4">To communicate with you about your use of the Services.</li>
          <li className="text-base lg:text-lg mb-4">To understand how you use the Services and to improve the Services.</li>
        </ul>
        <h2 className="text-2xl font-medium mb-4">Information Sharing and Disclosure</h2>
        <p className="text-base lg:text-lg mb-6">We may share your information in the following circumstances:</p>
        <ul className="list-disc pl-6">
          <li className="text-base lg:text-lg mb-4">With third-party service providers who perform services on our behalf, such as hosting providers, payment processors, and customer support providers.</li>
          <li className="text-base lg:text-lg mb-4">In response to legal process, such as a court order or subpoena.
          </li>
